...
const industryItems: WorkItem[] = [
  ...
  },
  {
    ...
    solutions: ["Code-splitting, prefetching", "Skeletons + image ratio handling"],
    impact: {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
        <div>
          ...
          <ul className="space-y-1">
            {item.responsibilities.slice(0, 4).map((res) => (
              <li key={res} className="text-gray-300 text-sm flex items-start">
        ...
        <div>
          ...
          <div className="text-gray-300 text-sm">
            <div className="mb-1">
              <span className="text-cyan-400">Metrics:</span> {item.impact.metrics}
            </div>
            <div>
              <span className="text-cyan-400">Business Value:</span> {item.impact.businessValue}
            </div>
          </div>
        </div>
      </div>
          ...
          <Container>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-gray-300">
                A selection of professional work across industry and freelance projects. Built with
                a focus on clarity, performance, and maintainability.
              </p>
            </div>
          </Container>
        </section>
