...
const services = [
  ...
  },
  {
    ...
    title: "UI/UX Design",
    description:
      "Beautiful and intuitive user interfaces that provide exceptional user experiences across all devices.",
  ...
  },
  {
    ...
    title: "Consulting",
    description:
      "Technical consultation and code reviews to help improve your existing projects and development processes.",
...
const process = [
  ...
  },
  {
    ...
    description:
      "Creating wireframes and interactive prototypes to visualize the final product.",
    icon: Palette,
  },
  {
    step: "03",
    title: "Development",
    description:
      "Building your project using cutting-edge technologies and best practices.",
    icon: Code2,
  },
  {
    step: "04",
